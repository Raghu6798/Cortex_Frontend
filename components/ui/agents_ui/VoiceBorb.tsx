...
export default function VoiceBorb({
  hue = 0,
  hoverIntensity = 0.2,
  rotateOnHover = true,
  ...
  const frag = /* glsl */ `
    ...
    vec4 draw(vec2 uv) {
      ...
      // Apply recording state color changes
      if (isRecording > 0.5) {
        color1 = mix(color1, vec3(1.0, 0.2, 0.2), 0.8);
        color2 = mix(color2, vec3(1.0, 0.4, 0.4), 0.8);
        color3 = mix(color3, vec3(0.8, 0.1, 0.1), 0.8);
      }
