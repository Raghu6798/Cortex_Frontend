        ...
        >
          <div className="flex items-center">
            {selectedProviderData?.logo_url && (
              <Image src={selectedProviderData.logo_url} alt={selectedProviderData.display_name} width={20} height={20} className="mr-3" />
            )}
          ...
          <div className="absolute z-10 mt-1 w-full bg-gray-800 border border-gray-700 shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none">
            {providers.map((provider) => (
              ...
              >
                <div className="flex items-center">
                  {provider.logo_url && (
                    <Image src={provider.logo_url} alt={provider.display_name} width={20} height={20} className="mr-3" />
                  )}
                  <div>
